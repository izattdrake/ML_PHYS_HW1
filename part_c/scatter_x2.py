...
ax.scatter(x2, y, label='True', color='black')
ax.scatter(x2, y_predicted, label='Predicted', color='dodgerblue')
...
save_axes_centered(fig, ax, f"norm_multi-house-age-scatter.pdf")    
